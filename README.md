...
Il fonctionne sur ordinateur (Linux/MacOS/Win). Il permet de paramétrer et de créer facilement les codes QR en ajoutant de manière transparente les balises nécessaires dans son contenu.

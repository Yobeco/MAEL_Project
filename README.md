...
- :page_facing_up: un texte qui sera lu par une voix de syhtèse ou bien 
- :microphone: un lien vers un fichier .mp3 :microphone: (pour le moment hébergé sur un Google Drive).

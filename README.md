...
Il fonctionne sur ordinateur (Linux/MacOS/Win) et permet de créer et paramétrer facilement le contenu des codes QR en ajoutant de manière transparente les balises nécessaires.
